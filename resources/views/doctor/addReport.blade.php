...
<div class="container-fluid p-0">
    ...
    <div class="bg-gradient-primary-to-secondary p-4 mb-4 rounded-3 shadow-sm">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2 class="text-white mb-2 fw-bold">{{ isset($report) ? 'Edit Medical Report' : 'New Medical Report' }}</h2>
                <p class="text-white-50 fs-5 mb-0">
                    <i class="bi bi-file-earmark-medical me-2"></i>
                    {{ isset($report) ? 'Updating' : 'Creating' }} report for {{ $appointment->patient->name }}
                </p>
            </div>
    ...
    <div class="card border-0 shadow-sm" style="border-radius: 15px;">
        <div class="card-body p-4">
            @if(isset($report))
                ...
                @method('PUT')
            @else
                <form action="{{ route('doctor.storeReport') }}" method="POST" enctype="multipart/form-data">
            @endif
                @csrf
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" 
                                   ...
                                   class="form-control" 
                                   required 
                                   value="{{ $report->report_date ?? old('report_date') }}">
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" 
                                           name="follow_up_date" 
                                           class="form-control" 
                                           value="{{ $report->follow_up_date ?? old('follow_up_date') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-4">
                        <button type="submit" class="btn btn-primary btn-lg w-100">
                            ...
                            {{ isset($report) ? 'Update Medical Report' : 'Save Medical Report' }}
                        </button>
                    </div>
                </div>
            </form>
