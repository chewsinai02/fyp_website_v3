...
<div class="container-fluid p-0">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="text-gradient fs-1 mb-2">Appointments Overview</h2>
            <p class="text-muted-light fs-5 mb-0">
                <i class="bi bi-calendar-check me-2"></i>
                Managing {{ $activeAppointmentsCount }} active appointment{{ $activeAppointmentsCount !== 1 ? 's' : '' }}
            </p>
        </div>
                        ...
                        @foreach($appointments as $appointment)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endphp
                                    <span class="badge bg-{{ $statusColor }}-subtle text-{{ $statusColor }} rounded-pill px-3">
                                        {{ $appointment->status }}
                                    </span>
                                </td>
                                <td>
