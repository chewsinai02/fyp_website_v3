...
@section('title', 'Nurse Admin Details')
@section('content')
<div class="container-fluid p-0" style="max-width: 1400px; margin: 0 auto;">
    <!-- Header Section -->
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="text-gradient fs-1 mb-2">Complete Nurse Admin Profile</h2>
    ...
    <div class="card">
        <div class="card-body p-4">
            <form method="POST" action="{{ route('admin.nurseadminUserdata.store', $userToEdit->id) }}" class="row g-4">
                @csrf
