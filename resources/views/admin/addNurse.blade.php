...
<div class="container-fluid p-0">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <div class="d-flex align-items-center gap-3 mb-2">
                <h2 class="text-gradient mb-0">Add New Nurse</h2>
            </div>
            <p class="text-muted-light">
                <i class="fa-solid fa-user-nurse me-2"></i>
                Fill in the details to add a new nurse
            </p>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body p-4">
            <form method="POST" action="{{ route('addNewNurse') }}">
                @csrf
                ...
                <div class="d-flex justify-content-end gap-3">
                    <a href="{{ route('nurseList') }}" class="btn btn-light">Cancel</a>
