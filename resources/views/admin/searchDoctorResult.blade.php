    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <div class="d-flex align-items-center gap-3 mb-2">
                <h2 class="text-gradient mb-0">Search Doctor</h2>
            </div>
            <p class="text-muted-light">Found {{ $users->count() }} doctor(s) matching your search</p>
        </div>
        
        <div class="d-flex gap-3 align-items-center">
            <!-- Add Doctor Button -->
            <a href="{{ route('addNewDoctor') }}" class="btn btn-primary">
