...
@section('title', 'List of Nurse')
@section('content')
<div class="container-fluid p-0">
    <!-- Header Section -->
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="text-gradient mb-2">List of Nurse</h2>
            <p class="text-muted-light">
                <i class="bi bi-people-fill me-2"></i>
                You have {{ $activeNurseCount }} active nurse{{ $activeNurseCount !== 1 ? 's' : '' }}
            </p>
        </div>
        
        <div class="d-flex gap-3 align-items-center">
            <!-- Add Nurse Button -->
            <a href="addNurse" class="btn btn-primary">
            ...
            <div class="search-container">
                <form method="GET" action="{{ route('searchNurse') }}" class="d-flex align-items-center">
    ...
    <!-- Nurse Table -->
    @if($users->where('role', 'nurse')->isEmpty())
        <div class="card">
            <div class="card-body text-center py-5">
                ...
                <h4 class="text-gradient">No Nurses Found</h4>
                <p class="text-muted-light mb-4">Start by adding your first nurse to the system</p>
                <a href="addNurse" class="btn btn-primary">
                    <i class="bi bi-plus-circle me-2"></i>
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="badge badge-nurse">Nurse</span>
                                                </div>
                                            </div>
                                        </td>
