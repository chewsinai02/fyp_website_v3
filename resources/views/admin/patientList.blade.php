...
<div class="container-fluid p-0">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="text-gradient mb-2">List of Patient</h2>
            <p class="text-muted-light">
                <i class="bi bi-people-fill me-2"></i>
                You have {{ $activePatientCount }} active patient{{ $activePatientCount !== 1 ? 's' : '' }}
            </p>
        </div>
    ...
    <!-- Patient Table -->
    @if($users->where('role', 'patient')->isEmpty())
        <div class="card">
            <div class="card-body text-center py-5">
                ...
                <h4 class="text-gradient">No Patients Found</h4>
                <p class="text-muted-light mb-4">Start by adding your first patient to the system</p>
                <a href="addPatient" class="btn btn-primary">
                    <i class="bi bi-plus-circle me-2"></i>
