...
<div class="container-fluid p-0">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="text-gradient mb-2">List of Doctor</h2>
            <p class="text-muted-light">
                <i class="bi bi-people-fill me-2"></i>
                You have {{ $activeDoctorsCount }} active doctor{{ $activeDoctorsCount !== 1 ? 's' : '' }}
            </p>
        </div>
        ...
        <div class="d-flex gap-3 align-items-center">
            ...
            <div class="search-container">
                <form method="GET" action="{{ route('searchDoctor') }}" class="d-flex align-items-center">
    ...
    <!-- Doctor Table -->
    @if($users->where('role', 'doctor')->isEmpty())
        <div class="card">
            <div class="card-body text-center py-5">
                ...
                <h4 class="text-gradient">No Doctors Found</h4>
                <p class="text-muted-light mb-4">Start by adding your first doctor to the system</p>
                <a href="addDoctor" class="btn btn-primary">
                    <i class="bi bi-plus-circle me-2"></i>
