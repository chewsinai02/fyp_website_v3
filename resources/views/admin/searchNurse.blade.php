    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <div class="d-flex align-items-center gap-3 mb-2">
                <h2 class="text-gradient mb-0">Search Nurse</h2>
            </div>
            <p class="text-muted-light">Found {{ $users->count() }} nurse(s) matching your search</p>
        </div>
        
        <div class="d-flex gap-3 align-items-center">
            <!-- Add Nurse Button -->
            <a href="{{ route('addNewNurse') }}" class="btn btn-primary">
    ...
    @if($users->isEmpty())
        <div class="card">
            <div class="card-body text-center py-5">
                ...
                <h4 class="mt-3">No nurse found</h4>
